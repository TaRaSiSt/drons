...
! function (a) {
    ...
    a.extend(a.fn, {
        ...
        messages: {
            ...
            remote: "Виправте це поле.",
            email: "Будь ласка, введіть дійсну адресу електронної пошти.",
            url: "Будь ласка, введіть коректну адресу.",
            date: "Будь ласка, введіть коректну дату.",
            dateISO: "Будь ласка, введіть коректну дату ( ISO ).",
            number: "Будь ласка, введіть коректне число.",
            digits: "Будь ласка, введіть тільки цифри.",
            creditcard: "Будь ласка, введіть дійсний номер картки.",
            equalTo: "Будь ласка, введіть значення ще раз.",
            maxlength: a.validator.format("Будь ласка, введіть не більше {0} символів"),
            minlength: a.validator.format("Будь ласка, введіть як мінімум {0} символів"),
            rangelength: a.validator.format("Введіть значення від {0} до {1} символів"),
            range: a.validator.format("Введіть значення від  {0} до {1}."),
            max: a.validator.format("Будь ласка, введіть значення менше або рівно {0}."),
            min: a.validator.format("Будь ласка, введіть значення більше або рівно {0}.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function () {
